...
Pharo 9 is under active development and changes in Pharo may require corresponding changes in Sparkle. These instructions use build number =buildNumber=; the latest builds known to work are documented here: <A HREF="https://github.com/GemTalk/Sparkle/wiki#current-pharo-build" CLASS="URL">https://github.com/GemTalk/Sparkle/wiki#current-pharo-build</A>. 
...
5.	Select the specific build (currently =buildNumber=); this may require scrolling through more recent build numbers. Be sure you select the 64-bit image.
...
1.	Launch the Pharo 9.0 build =buildNumber= image.
