...
Pharo 9 is under active development and changes in Pharo may require corresponding changes in Sparkle. These instructions use build number =buildNumber=; the current build in use is documented here: <A HREF="https://github.com/GemTalk/Sparkle/wiki#current-pharo-build" CLASS="URL">https://github.com/GemTalk/Sparkle/wiki#current-pharo-build</A>. 
